...
module LoadTestHelper
  ...
  # log the time for executing a block of code
  #   test failure will be ignored in normal execution mode (shown in TestWise debugging mode), but will be saved with the results
  # 
  # Usage
